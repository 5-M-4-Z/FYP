...
with open(file_path, "r") as file:
    ...
    for line in file:
        ...
        f"hole_x={hole_xx}, "
        f"hole_y={hole_yy}, "
        f"trunc_x={truncation_x}, "
        f"trunc_y={truncation_y}, "
        f"patch_xsize={patch_xsize_num}, "
        f"patch_ysize={patch_ysize_num}, "
        f"patch_x={patch_x_num}, "
        f"patch_y={patch_y_num}")
